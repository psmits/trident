...
Additional comparison of in-sample model performance at each of the time intervals reveals just how similar in adequacy our models performance are to each other (Fig. \ref{fig:auc_ts}). There are few if any obvious differences between the models in their performances.
