...
When the posterior predictive distributions of the in-sample AUC estimates are presented by taxonomic group, some heterogeneity in model adequacy is revealed (Fig. \ref{fig:auc_taxon}).
\begin{figure}[ht]
  \centering
...
Finally, when the posterior predictive distributions of the in-sample AUC estimates are presented over time and by taxonomic group, SOMETHING (Fig. \ref{fig:auc_taxon_time}).
\begin{figure}[ht]
  \centering
